          ...
          <div class="col-md-8 col-md-offset-4">
             ...
             <div class="col-md-6 ">
                <div class="form-group" style="text-align: center">
                 <p style="color: orange">Payment Type</p>
                
                  <select name="profession" class="form-control">
                    
                    <option value="Govt Job">payment Type</option>
                    <option value="Govt Job">Cash</option>
                    <option value="Private Job">Cheque</option>
                    <option value="Business">EMI</option>
                    
                  </select>
                  <div class="col-md-12">
              <a class="btn btn-warning" href="paymentsuccess.php" role="button">Pay</a>
              </div>
                </div>
              </div>
            </div>
