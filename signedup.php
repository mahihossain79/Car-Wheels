...
<html lang="en">
  ...
  <body >
        ...
        <div class="jumbotron" id="jumbotron">
          <h1 class="display-5" style="text-align: center;color: red;">Congratulations! You have Successfully Signed Up.</h1>
          <p style="text-align: center; font-size: 150%; "> <a href="paymentdetails.php">Proceed to payment</a> </p>
        </div>
